...
class CommonPlatform ():
    PackagesSupported = ("z70Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('z70', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "z70", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "z70Pkg/z70.dsc", "Platform Hardcoded")
